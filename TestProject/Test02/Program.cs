...
namespace Test02 {
    ...
    class Program {
        ...
        private static void Exercise02(List<int> numbers) {
            var gMax = numbers.Where(x => x % 2 == 0)
                .Max();
        ...
        private static void Exercise03(List<int> numbers) {
            var kMin = numbers.Where(x => x % 2 == 0);
                //.OrderByDescending(numbers);
        ...
        private static void Exercise04(List<int> numbers) {
            var mid = numbers.Where(x => 10 <= x || x >= 50);
        ...
        private static void Exercise06(List<Person> persons) {
            var hi = persons.Where(x => x.Height >= 170);
            var we = hi.Average(x => x.Weight);
        ...
        private static void Exercise07(List<Person> persons) {
            var wei = persons.Where(x => x.Weight <= 70);

            foreach(Person person in wei) {
        ...
        private static void Exercise08(List<Person> persons) {
            var yama = persons.Where(y => y.Name.Contains("山"));
